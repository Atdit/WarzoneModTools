...
public enum Color { // Copy of EnumChatFormatting, to shorten the name
    BLACK("BLACK", '0', 0),
    ...
    private static final Map<String, Color> nameMapping = Maps.<String, Color>newHashMap();
    /**
    ...
    private Color(String formattingName, char formattingCodeIn, int colorIndex) {
        this(formattingName, formattingCodeIn, false, colorIndex);
    }

    private Color(String formattingName, char formattingCodeIn, boolean fancyStylingIn) {
        this(formattingName, formattingCodeIn, fancyStylingIn, -1);
    }

    private Color(String formattingName, char formattingCodeIn, boolean fancyStylingIn, int colorIndex) {
     ...
     */
    public static Color getValueByName(String friendlyName) {
        return friendlyName == null ? null : (Color) nameMapping.get(func_175745_c(friendlyName));
    }

    public static Color func_175744_a(int p_175744_0_) {
        if (p_175744_0_ < 0) {
            return RESET;
        } else {
            for (Color Color : values()) {
                if (Color.getColorIndex() == p_175744_0_) {
                    return Color;
                }
            }
    ...
    public static Collection<String> getValidValues(boolean p_96296_0_, boolean p_96296_1_) {
        ...
        for (Color Color : values()) {
            if ((!Color.isColor() || p_96296_0_) && (!Color.isFancyStyling() || p_96296_1_)) {
                list.add(Color.getFriendlyName());
            }
        }
    ...
    static {
        for (Color Color : values()) {
            nameMapping.put(func_175745_c(Color.name), Color);
        }
    }
}
